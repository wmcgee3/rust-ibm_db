    ...
    if env_var_not_present {
        if Path::new(&value).exists() {
            ...
            if os.contains("Windows") {
                ...
                println!(
                    "This is a {} os & {} bit system. Download file is: {}",
                    os, os_arch, cli_file_name
                );
            ...
            let env_path_tmp =
                env::var("IBM_DB_HOME").unwrap_or("Unable to Set Path. Please set.".to_string());
